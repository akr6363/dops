...
function App() {
    ...
    const removeTodolist = (todolistId: string) => {
        ...
        const {[todolistId]: removedTodolist, ...restTasks} = tasks;
        setTasks(restTasks);
    }

    function removeTask(todolistId: string, taskId: string) {
        const newTasksList = tasks[todolistId].data.filter(el => el.id !== taskId)
        setTasks({...tasks, [todolistId]: {...tasks[todolistId], data: newTasksList}})
    }
